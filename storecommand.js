...
(function() {
    ...
    addCommand("store", {
        onCommand: function(sender, args) {
            ...
            // Clickable link
            const linkComp = Component.text("https://store.aeronami.net")
                .color(TextColor.color(0xCBC3E3))
                .clickEvent(ClickEvent.clickEvent(ClickEvent.Action.OPEN_URL, "https://store.aeronami.net"));
    ...
    log.info("/store command loaded successfully with clickable link!");
})();
